...
static constexpr float TEMP_HIGH_THRESHOLD_C = 60.0f;
...
static constexpr uint32_t FIREBASE_UPLOAD_PERIOD_MS = 5000;
...
static constexpr uint32_t FIREBASE_ALERT_COOLDOWN_MS = 60000;
static constexpr uint32_t TELEGRAM_ALERT_COOLDOWN_MS = 30000;
